        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VenueName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendeeUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Users_AttendeeUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrPayload = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_AttendeeUserId",
                table: "Bookings",
                column: "AttendeeUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_EventId_AttendeeUserId",
                table: "Bookings",
                columns: new[] { "EventId", "AttendeeUserId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_EventId_AttendeeUserId",
                table: "Feedbacks",
                columns: new[] { "EventId", "AttendeeUserId" });
